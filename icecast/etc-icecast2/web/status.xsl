...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Noto+Sans:wght@400;700" rel="stylesheet" />
</head>
<body>
	<h1 id="header">Icecast2 Status</h1>

  <header style="text-align: center; font-size: 1.3rem; font-weight: 700; margin-bottom: 1.5rem;">
    [<a href="/listen.mp3.m3u">LISTEN (M3U)</a>]
    [<a href="/listen.mp3">LISTEN (MP3)</a>]
  </header>

  <div class="player">
    <audio class="player" controls="true" loop="true" preload="metadata" src="/listen.mp3">Your browser does not support the <code>audio</code> element.</audio>
  </div>
	...
	<div id="footer">
		View on <a href="https://github.com/klulz/icecast-server">GitHub</a>. Based on <a href="https://www.icecast.org/">www.icecast.org</a>
	</div>
</body>
</html>
</xsl:template>
